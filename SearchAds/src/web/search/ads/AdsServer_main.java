...
5. Adslocation: only ads with rankScore > mainlineReservePrice can be allocated on mainline.
...
public class AdsServer {
	public static void main(String[] args) throws IOException {
		...
		String mysql_user = "xxx";
		String mysql_pass = "xxx";
		...
		if(adsEngine.init())
		{
			...
			try{
				...
				while((query=br.readLine())!=null){
					...
					List<Ad> adsCandidates = adsEngine.selectAds(query); // select the relevent ad from the ad database according to the query
