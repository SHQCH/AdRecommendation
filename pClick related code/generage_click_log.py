...
#items is dict <key value>, key is the data, value is weight;
#randomly selected a key in items, with specified weights
...
def random_campaignId(exclusive_campaign_id):   #return a random element in input
...
#    32772,     87843,    1484380913882, bluetooth speaker, 2503, 8199,           1,                               1
...
if __name__ == "__main__":
    ...
    # use reverse engineering to generate the click_log
    # user information: ip+5deviceID
    # ads information: 从amazon 爬下来的数据，query的search results
    ...
    with open(ad_input_file, "r") as lines:
        for line in lines:
            ...
            ad_list.append(entry)[entry["adId"]] = entry["query"].lower()
