...
if __name__ == "__main__":
    ...
    data = sc.textFile("/Users/mac/project/SearchAds/data/log/ctr_features_sample/part*")
    (trainingData, testData) = data.randomSplit([0.7, 0.3])
    parsedTrainData = trainingData.map(parsePoint)  # map function will be applied to each input line,
    ...
    # Save and load model
    model.save(sc, "/Users/mac/project/SearchAds/data/model/ctr_gbdt_model_demo_small")
